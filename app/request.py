...
def get_sources(category):
    '''
    Function that gets the object in response to our request
    '''
...
def process_sources(sources_list):
    '''
    Args:
        Function that gets the news sources and transforms them to a list of objects
    Returns:
        news_sources: A list of news sources
    '''
    news_articles = []
...
def get_news(id):
    '''
    Function that gets the news object from our request.
    '''
...
def get_category(category):
    '''
    Function that gets the object from request
    '''
...
def process_categories(categories_list):
    '''
    Function that processes the news categories and transforms them to a list of objects
    '''
